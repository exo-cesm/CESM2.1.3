# 1% PAL CH4 em0.1 case setup instructions

The resolution used was 2.5 by 1.875 degrees (f19_g17)

Example case setup command:
./create_newcase --compset BWma1850 --res f19_g17 --case ~/b.e21.BWma1850.f19_g17.1pc_o2.CH4_0.1_PD_flux.001 --run-unsupported
...
See the example user_nl_cam for how to include the present day methane emission file: CH4_0.1_PD_emissions.nc
