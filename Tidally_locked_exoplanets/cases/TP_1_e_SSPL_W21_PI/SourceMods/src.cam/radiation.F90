...
subroutine radiation_tend( &
   ...
   caldaytrunc = real(10.4167) ! G.Cooke 2020 edit to keep the day on 10.
   ...
   if (use_rad_uniform_angle) then
      do i = 1, ncol
         coszrs(i) = shr_orb_cosz(caldaytrunc, clat(i), clon(i), delta, 0._r8, uniform_angle=rad_uniform_angle)
      end do
   else
      do i = 1, ncol
         coszrs(i) = shr_orb_cosz(caldaytrunc, clat(i), clon(i), delta, 0._r8)
      end do
   end if
